...
class MidonetL2GatewayMixin(l2gateway_db.L2GatewayMixin):
    ...
    def validate_l2_gateway_connection_for_create(self, context,
        ...
        # For kilo, this method doesn't exist in upstream code. To keep the
        # same validation code as that of master in networking-midonet, call
        # this method from MidonetL2GatewayPlugin.
