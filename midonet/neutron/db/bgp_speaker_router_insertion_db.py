...
from midonet.neutron.db import bgp_db as bdb
from midonet.neutron.extensions import bgp as bgp_ext
...
class BgpSpeakerRouterInsertionDbMixin(object):
    ...
    def set_router_for_bgp_speaker_by_network(self, context,
        ...
        subnets = [core_plugin._make_subnet_dict(subnet_db) for subnet_db in
                   core_plugin._get_subnets_by_network(context, net_id)]
        if not subnets:
