...
LOGGING_PLUGIN_KLASS = ('midonet.neutron.services.logging_resource.plugin.'
...
NOT_FOUND_FW_UUID = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"
NOT_FOUND_LOG_RES_UUID = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"
NOT_FOUND_FW_LOG_UUID = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"
...
class LoggingResourceTestCase(test_l3.L3NatTestCaseMixin,
    ...
    def setUp(self, plugin=None, service_plugins=None, ext_mgr=None):
        ...
        service_plugins = {
            ...
            'fwaas_plugin_name': tfp.FW_PLUGIN_KLASS}
