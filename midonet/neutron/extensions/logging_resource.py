...
class LoggingResourceNotFound(exceptions.NotFound):
    message = _("Logging resource %(id)s does not exist")


class FirewallLogNotFound(exceptions.NotFound):
...
RESOURCE_ATTRIBUTE_MAP = {
    'logging_resources': {
        ...
        'description': {
            ...
            'validate': {'type:string': constants.LONG_DESCRIPTION_MAX_LEN},
            'default': '', 'is_visible': True},
        ...
        'parameters': dict((LOG_COMMON_FIELDS),
                      **{
                        'description': {
                            ...
                            'validate': {
                                'type:string':
                                    constants.LONG_DESCRIPTION_MAX_LEN},
                            'default': '', 'is_visible': True},
                        'firewall_id': {
...
class Logging_resource(extensions.ExtensionDescriptor):
    ...
    def get_resources(cls):
        ...
        n_const.COMMON_PREFIXES['LOGGING_RESOURCE'] = LOGGING_PREFIX
